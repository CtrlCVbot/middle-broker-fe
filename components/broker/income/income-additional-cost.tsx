...
import { AdditionalFeeType } from "@/types/income";
import { DollarSign, Plus, Trash2 } from "lucide-react";
import { formatCurrency } from "@/lib/utils";

interface IncomeAdditionalCostProps {
  incomeId: string;
  orderIds: string[];
}

export function IncomeAdditionalCost({ incomeId, orderIds }: IncomeAdditionalCostProps) {
  const { incomeDetail, addAdditionalFee, removeAdditionalFee } = useIncomeDetailStore();
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 추가금 목록 */}
      {incomeDetail && incomeDetail.additionalFees.length > 0 ? (
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className={`text-right font-semibold ${incomeDetail.totalAdditionalAmount >= 0 ? "text-blue-600" : "text-red-600"}`}>
