...
// 타입
import { ISettlementWaitingItem, IPurchaseBundleItemWithDetails } from "@/types/broker-charge-purchase";
              ...
              {adjustmentsLoading ? (
                ...
                displayData.map((item, index) => {
                  ...
                  if (mode === 'waiting') {
                    ...
                    const freightItem = item as IPurchaseBundleItemWithDetails;
