  ...
  try {
    ...
    if (dispatch) {
      dispatchDetail = {
        ...
        brokerCompanySnapshot: dispatch.brokerCompanySnapshot,
        brokerManagerId: dispatch.brokerManagerId || '',
        brokerManagerSnapshot: dispatch.brokerManagerSnapshot,
        assignedDriverId: dispatch.assignedDriverId || '',
        assignedDriverSnapshot: dispatch.assignedDriverSnapshot,
        ...
        createdBySnapshot: dispatch.createdBySnapshot,
        updatedBy: dispatch.updatedBy || '',
        updatedBySnapshot: dispatch.updatedBySnapshot,
