...
const CreateSalesBundleSchema = z.object({
  ...
  bankCode: z.string().optional().nullable().transform(val => val === '' ? null : val),
  bankAccount: z.string().optional().nullable().transform(val => val === '' ? null : val),
  bankAccountHolder: z.string().optional().nullable().transform(val => val === '' ? null : val),  
